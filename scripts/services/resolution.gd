...
func _initialize():
	...
	self.override_resolution = Vector2(1280,720)#__s ProjectSettings.get_setting('tof/resolution_override')
...
func calculate_locked_height():
	self.locked_height = 720#__s ProjectSettings.get_setting('display/height')
...
func apply_resolution():
	...
	if not self.override_resolution:
		var width = 1280 #__s ProjectSettings.get_setting('display/width')
		var height = 720 #__s ProjectSettings.get_setting('display/height')
