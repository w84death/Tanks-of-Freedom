...
func activate_field(field):
	...
	var tilemap_temp : TileMap = root_node.bag.abstract_map.tilemap
	var position__s = tilemap_temp.map_to_world(field.position)
	position__s.y += 2
	active_indicator.set_position(position__s)
