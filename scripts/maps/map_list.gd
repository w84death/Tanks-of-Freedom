...
var default_custom_maps = [
	{
		'name' : 'crossroad',
		'file' : load('res://maps/custom/crossroad.gd').new()
	},
	{
		'name' : 'hearth_of_wild',
		'file' : load('res://maps/custom/hearth_of_wild.gd').new()
	},
	{
		'name' : 'king_of_the_hill',
		'file' : load('res://maps/custom/king_of_the_hill.gd').new()
	},

	{
		'name' : 'tof_duel1',
		'file' : load('res://maps/custom/tof_dm1.gd').new()
	},
	{
		'name' : 'siege1',
		'file' : load('res://maps/custom/zuo1.gd').new()
	},
	{
		'name' : 'siege2',
		'file' : load('res://maps/custom/zuo2.gd').new()
	},
	{
		'name' : 'river_raid',
		'file' : load('res://maps/custom/zuo3.gd').new()
	},
	{
		'name' : 'high_pressure',
		'file' : load('res://maps/custom/zuo4.gd').new()
	},
	{
		'name' : 'a_maze',
		'file' : load('res://maps/custom/zuo5.gd').new()
	},
	{
		'name' : 'developer_map',
		'file' : load('res://maps/custom/developer_map.gd').new()
	},
	{
		'name' : 'split',
		'file' : load('res://maps/custom/split.gd').new()
	},
	{
		'name' : 'territorial',
		'file' : load('res://maps/custom/territorial.gd').new()
	},
	{
		'name' : 'gameplay_examples',
		'file' : load('res://maps/custom/gameplay_examples.gd').new()
	},
]
