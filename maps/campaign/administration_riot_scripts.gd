var stories = {
    'introduction' : [
        ...
        {'action' : 'camera', 'details' : {'where' : Vector2(15, 3), 'zoom' : 1}, 'delay' : 0.5},
        ...
        {'action' : 'camera', 'details' : {'where' : Vector2(4, 3), 'zoom' : 1}, 'delay' : 0.5},
        {'action' : 'message', 'details': {'text' : 'MISSION_3_OBJECTIVE', 'portrait' : 'officer_red', 'name' : 'ACTOR_MILITIA_OFFICER', 'side' : 'left'}},
        {'action' : 'camera', 'details' : {'where' : Vector2(14, 6), 'zoom' : 1}, 'delay' : 0.5},
