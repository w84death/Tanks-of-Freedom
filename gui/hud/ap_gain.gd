...
func update():
    ...
    self.root.dependency_container.controllers.hud_panel_controller.info_panel.set_ap_gain(gain)

func calculate_gain():
    var total_ap_gain = 0
    var current_player = self.root.dependency_container.controllers.action_controller.current_player
